		...
		&pb_config.DirectorConfig{
			Grpc: &pb_config.DirectorConfig_Grpc{
				Routes: []*pb_grpcroutes.Route{
					{
						Autogenerated:        false,
						AuthorityHostMatcher: "something",
	...
	expectedDirectorConfig := &pb_config.DirectorConfig{
		Grpc: &pb_config.DirectorConfig_Grpc{
			Routes: []*pb_grpcroutes.Route{
				...
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.external2.host.com",
					AuthorityPortMatcher: 1,
					BackendName:          "s2_ns1_1",
				},
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.external2.host.com",
					AuthorityPortMatcher: 2,
					BackendName:          "s2_ns1_two",
				},
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.external2.host.com",
					AuthorityPortMatcher: 3,
					BackendName:          "s2_ns1_3",
				},
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.external2.host.com",
					AuthorityPortMatcher: 222,
					BackendName:          "s2_ns1_two",
				},
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.external2.host.com",
					AuthorityPortMatcher: 447,
	...
	expectedDirectorConfig2 := &pb_config.DirectorConfig{
		Grpc: &pb_config.DirectorConfig_Grpc{
			Routes: []*pb_grpcroutes.Route{
				...
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.ns1.svc.external.example.com",
					AuthorityPortMatcher: 1,
					BackendName:          "s2_ns1_1",
				},
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.ns1.svc.external.example.com",
					AuthorityPortMatcher: 4,
					BackendName:          "s2_ns1_four",
				},
				{
					Autogenerated:        true,
					AuthorityHostMatcher: "s2.ns1.svc.external.example.com",
					AuthorityPortMatcher: 5,
